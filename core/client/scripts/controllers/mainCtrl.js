angular.module('cmf')
	.controller('mainCtrl', function($scope, sampleData, auth, $state, $stateParams, filteredService) {
		$scope.test = "hello";
		...
		$scope.setFiltered = function(filteredArr) {
			filteredService.setFilteredArray();
